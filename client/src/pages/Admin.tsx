...
const mockProducts = [
  {
    ...
    description: "Transform your space with this elegant diffuser that creates a calming atmosphere with beautiful light patterns.",
    price: 89.99,
    ...
    isNew: false,
    isBestSeller: true,
    tags: ["wellness", "aromatherapy", "lighting"]
  }
];
...
export default function Admin() {
  ...
  const stats = {
    ...
    lowStockItems: mockProducts.filter(p => !p.inStock).length,
